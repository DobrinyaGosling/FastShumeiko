...
from app.auth.utils import get_user_id_by_access_token, get_lord_id_by_access_token
from app.hotels.schemas import HotelsSchema, UpdateHotelsSchema, StrSchema, RoomsSchema, AddRoomsSchema, IntIntSchema, UpdateRoomsSchema
...
async def get_my_hotel(
    ...
    return HotelsSchema(name=hotel.name, location=hotel.location, services=hotel.services, image_id=hotel.image_id, rooms_quantity=hotel.rooms_quantity)
...
async def get_hotels(
    ...
    return await HotelsDAO(session).find_all()
